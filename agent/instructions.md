...
Likewise, call `score_backlog` **once per answer** with all the appids you care about, up to 20 — not once per game, and not twice for the same set. If you need games you did not score, call it once more with only the new appids.
